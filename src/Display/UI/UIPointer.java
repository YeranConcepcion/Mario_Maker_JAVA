...
//					if (kill) {
//						g.drawImage(getTint(idle.getCurrentFrame()), x, y, width, height, null);
//						g.drawImage(hit.getCurrentFrame(), (int) this.handler.getCamera2().getX(), (int) this.handler.getCamera2().getY(), handler.getWidth(), handler.getHeight(), null);
//						handler.getLuigi().setX(handler.getLuigi().getX() - 30);
//						handler.getLuigi().setY(handler.getLuigi().getY() - 30);
//						if (handler.getLuigi().x <= handler.getCamera2().getX() - handler.getWidth() / 6 && handler.getLuigi().y <= handler.getCamera2().getY() - handler.getHeight() / 6) {
//							kill = false;
//							killed = true;
//							attacking = false;
//							outOfCamera = false;
